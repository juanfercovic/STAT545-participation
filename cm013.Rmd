...
1. The reader can observe the reelevant variation
1. The readerncan observe the relation between variables
1. It has to be self explicative ie: labels must be clear
1. 
1.
...
- <<Your answer here (and make sure to explain why you chose this answer)>>
Don't know. The graph is terrible. The scale is too large. No x axis, don't know the time spam.
