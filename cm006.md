...
# the pipe takes the previous thing and adds it into the first argument of the next line
gapminder %>%
...
```r
#cmd +shift+m --> this will generate pipe operators
```
...
3. Repeat 1, but take data from countries Brazil, and China. 
